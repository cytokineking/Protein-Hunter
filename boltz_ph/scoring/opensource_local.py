...
# -----------------------------------------------------------------------------
# Dummy Modal app placeholders (local port)
# -----------------------------------------------------------------------------

class _DummyApp:
    """Shim to keep legacy Modal-decorated functions importable locally."""
...
# These names are referenced by legacy Modal GPU wrapper decorators below.
app = _DummyApp()
opensource_scoring_image = None
    ...
    try:
        ...
        if not classifier_path or not os.path.isfile(classifier_path):
            ...
            for default_cfg in [
                ...
                str(Path(__file__).resolve().parents[2] / "utils" / "opensource_scoring" / "freesasa_naccess.cfg"),
            ]:
...
# =============================================================================
# LEGACY MODAL GPU WRAPPERS (NO-OP LOCALLY)
# =============================================================================
